...
export default class Todo extends Component {
    ...
    toggle = (id,dispatch)=>{
        axios.put(`/todos/${id}`)
        .then(()=>dispatch({type:"TOGGLE" ,payload:id}))
    }
    ...
    return (
        ...
        <i className="far fa-times-circle fa-sm float-left m-2 text-danger"
        onClick= {this.remove.bind(this,_id,dispatch)}></i>{title}
